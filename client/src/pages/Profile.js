...
// material ui
import { Box, Container, Grid, Button, Typography, useMediaQuery } from '@material-ui/core';
...
const Profile = () => {
    const mediaQueryBreakpoint = useMediaQuery('min-1024px');
